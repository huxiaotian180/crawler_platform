...
# 鹏元征信报告
def from_url_py(url, data, targetPath):
    # w文件命名规则
    ...
    pdf_file_name = data['apply_no'] + '_py_' + str(data["file_seq_no"]) + '.pdf'
...
def crew_py(url, data, targetPath):
    from_url_py(url, data, targetPath)
